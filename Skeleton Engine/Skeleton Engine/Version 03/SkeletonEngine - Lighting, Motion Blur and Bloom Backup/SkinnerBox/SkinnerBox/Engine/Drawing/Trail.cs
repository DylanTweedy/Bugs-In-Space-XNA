...
namespace SkeletonEngine
{
    class Trail
    {
        ...
        public void Draw(GraphicsDevice graphics, int camera)
        {
            ...
            Vector2 offset = -new Vector2(CameraManager.MainCameras[camera].PositionX * 2000000f, CameraManager.MainCameras[camera].PositionY * 2000000f);
            Vector2 offset2 = -new Vector2(CameraManager.MainCameras[camera].PositionX, CameraManager.MainCameras[camera].PositionY);
            Vector2 offset3 = -new Vector2(2000000f, 2000000f);
            BasicEffect basicEffect = GlobalVariables.basicEffect;

            basicEffect.World = Matrix.CreateTranslation(offset.X, offset.Y, 0) * Matrix.CreateRotationZ(CameraManager.MainCameras[camera].Rotation);
            ...
            basicEffect.View = CameraManager.MainCameras[camera].Transform;
