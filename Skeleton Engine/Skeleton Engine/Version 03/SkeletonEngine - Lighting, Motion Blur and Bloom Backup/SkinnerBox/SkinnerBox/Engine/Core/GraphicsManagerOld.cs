...
{
    [Serializable()]
    static class GraphicsManagerOld
    {
        /// <summary>
        ...
        {
            SaveFile.Save(ScreenData, SaveFile.SettingsLocation, "ScreenData");
        }
        ...
        {
            return (List<ScreenDataSave>)SaveFile.Load(SaveFile.SettingsLocation + "ScreenData");
        }
