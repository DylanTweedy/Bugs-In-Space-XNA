...
namespace SkeletonEngine
{
    ...
    static class GraphicsManager
    {
        ...
        static public List<TextLine> Information()
        {
            ...
            if (FullScreen)
            {
                Info.Add(new TextLine("Resolution", "" + CurrentSetup.FullScreenSettings[ActiveDisplay].ScreenResolution, true, ": "));
                Info.Add(new TextLine("Aspect Ratio", "" + CurrentSetup.FullScreenSettings[ActiveDisplay].AspectRatio, true, ": "));
                Info.Add(new TextLine("Virtual Resolution", "" + CurrentSetup.FullScreenSettings[ActiveDisplay].VirtualResolution, true, ": "));
                Info.Add(new TextLine("Virtual Aspect Ratio", "" + CurrentSetup.FullScreenSettings[ActiveDisplay].VirtualAspectRatio, true, ": "));
                Info.Add(new TextLine("Max Virtual Resolution", "" + CurrentSetup.FullScreenSettings[ActiveDisplay].MaxResolution, true, ": "));
            }
            else
            {
                Info.Add(new TextLine("Resolution", "" + CurrentSetup.WindowedSettings[ActiveDisplay].Resolution, true, ": "));
                Info.Add(new TextLine("Aspect Ratio", "" + CurrentSetup.WindowedSettings[ActiveDisplay].AspectRatio, true, ": "));
                Info.Add(new TextLine("Virtual Resolution", "" + CurrentSetup.WindowedSettings[ActiveDisplay].VirtualResolution, true, ": "));
                Info.Add(new TextLine("Virtual Aspect Ratio", "" + CurrentSetup.WindowedSettings[ActiveDisplay].VirtualAspectRatio, true, ": "));
                Info.Add(new TextLine("Max Virtual Resolution", "" + CurrentSetup.WindowedSettings[ActiveDisplay].MaxResolution, true, ": "));
                Info.Add(new TextLine("Window State", "" + CurrentSetup.WindowedSettings[ActiveDisplay].WindowState, true, ": "));
                Info.Add(new TextLine("Restored Bounds", "" + CurrentSetup.WindowedSettings[ActiveDisplay].RestoredBounds, true, ": "));
            }
