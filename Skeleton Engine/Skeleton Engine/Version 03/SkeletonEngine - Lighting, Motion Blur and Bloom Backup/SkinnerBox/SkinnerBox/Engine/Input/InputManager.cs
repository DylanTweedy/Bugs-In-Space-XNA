...
namespace SkeletonEngine
{
    ...
    static class InputManager
    {
        ...
        static public Vector2 GetMousePosition(int camera)
        {
            ...
            float WorldAngle = -CameraManager.MainCameras[camera].Rotation;
            ...
            return CameraManager.MainCameras[camera].Position + (new Vector2(2000000, 2000000) * new Vector2(CameraManager.MainCameras[camera].PositionX, CameraManager.MainCameras[camera].PositionY)) + (MousePosition / CameraManager.MainCameras[camera].Zoom);
        }
