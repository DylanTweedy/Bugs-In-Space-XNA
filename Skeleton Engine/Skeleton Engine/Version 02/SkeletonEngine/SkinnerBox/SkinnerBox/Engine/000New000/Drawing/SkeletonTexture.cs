...
namespace SkeletonEngine
{
    ...
    public class SkeletonTexture
    {
        ...
        public void Draw(Vector2 Position, Color Tint, float Rotation, float Scale, SpriteEffects Flip, float Layer)
        {
            Draw(Position, Vector2.One, Tint, Rotation, Vector2.One * Scale, Flip, Layer);
        }

        public void Draw(Vector2 Position, Vector2 DrawRectangle, Color Tint, float Rotation, float Scale, SpriteEffects Flip, float Layer)
        {
            Draw(Position, DrawRectangle, Tint, Rotation, Vector2.One * Scale, Flip, Layer);
        }

        public void Draw(Vector2 Position, Color Tint, float Rotation, Vector2 Scale, SpriteEffects Flip, float Layer)
        {
            Draw(Position, Vector2.One, Tint, Rotation, Scale, Flip, Layer);
        }

        public void Draw(Vector2 Position, Color Tint, float Rotation, float Scale, SpriteEffects Flip)
        {
            Draw(Position, Vector2.One, Tint, Rotation, Vector2.One * Scale, Flip, 0f);
        }

        public void Draw(Vector2 Position, Vector2 DrawRectangle, Color Tint, float Rotation, float Scale, SpriteEffects Flip)
        {
            Draw(Position, DrawRectangle, Tint, Rotation, Vector2.One * Scale, Flip, 0f);
        }

        public void Draw(Vector2 Position, Color Tint, float Rotation, Vector2 Scale, SpriteEffects Flip)
        {
            Draw(Position, Vector2.One, Tint, Rotation, Scale, Flip, 0f);
        }

        public void Draw(Vector2 Position, Vector2 DrawRectangle, Color Tint, float Rotation, Vector2 Scale, SpriteEffects Flip)
        {
            Draw(Position, DrawRectangle, Tint, Rotation, Scale, Flip, 0f);
        }

        #endregion

        public void Draw(Vector2 Position, Vector2 DrawRectangle, Color Tint, float Rotation, Vector2 Scale, SpriteEffects Flip, float Layer)
        {
