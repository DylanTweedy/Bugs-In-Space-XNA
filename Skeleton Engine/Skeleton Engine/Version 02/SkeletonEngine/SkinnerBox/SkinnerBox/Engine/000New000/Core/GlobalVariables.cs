...
namespace SkeletonEngine
{
    static class GlobalVariables
    {
        ...
        static public byte TileSize = 16;
        //static public byte ChunkSize = 32;
        ...
        static public float GravitationalConstant2D = 2.45230827374f;
        static public long MassConstant = 262144;
        static public int SpeedOfLight = 299792485;
        static public float CameraChunkSize = 2000384f;

        //Terrain Generation.
        static public int ChunkSize = 512;

        //Physics TimeStep
        static float PhysicsTimer = 0f;
        static public float PhysicsTime = 1f / 60f;
        static public int PhysicsSteps = 0;

        //Temporary Variables
        static public SpacePosition TempSP;
