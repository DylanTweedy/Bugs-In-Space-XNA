...
namespace SkeletonEngine
{
    static class StaticInfoBox
    {
        ...
        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation, string font)
        {
            Draw(Position, Scale, Alpha, Rotation, font, Vector2.Zero, Vector2.Zero, new Color(0, 0, 0, 0), Vector2.Zero, null);
        }

        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation, string font, Color BackgroundColor, Vector2 BoxPadding, BorderStyle Border)
        {
            Draw(Position, Scale, Alpha, Rotation, font, Vector2.Zero, Vector2.Zero, BackgroundColor, BoxPadding, Border);
        }

        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation)
        {
            Draw(Position, Scale, Alpha, Rotation, "", Vector2.Zero, Vector2.Zero, new Color(0, 0, 0, 0), Vector2.Zero, null);
        }

        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation, Color BackgroundColor, Vector2 BoxPadding, BorderStyle Border)
        {
            Draw(Position, Scale, Alpha, Rotation, "", Vector2.Zero, Vector2.Zero, BackgroundColor, BoxPadding, Border);
        }

        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation, Vector2 boxSize, Vector2 Alignment, Color BackgroundColor, Vector2 BoxPadding, BorderStyle Border)
        {
            Draw(Position, Scale, Alpha, Rotation, "", boxSize, Alignment, BackgroundColor, BoxPadding, Border);
        }

        static public void Draw(Vector2 Position, float Scale, float Alpha, float Rotation, string font, Vector2 boxSize, Vector2 Alignment, Color BackgroundColor, Vector2 BoxPadding, BorderStyle Border)
        {
            ...
            if (BackgroundColor.A != 0)
                Box.Draw(Position, BackgroundColor * Alpha, Rotation, (BoxSize * FinalScale) + (BoxPadding * 2f), SpriteEffects.None);
