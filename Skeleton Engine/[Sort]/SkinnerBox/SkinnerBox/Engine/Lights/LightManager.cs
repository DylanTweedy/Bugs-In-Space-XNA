...
namespace SkeletonEngine
{
    static class LightManager
    {
        ...
        static public void StartColorMap(GraphicsDevice graphicsDevice, RenderTarget2D renderTarget, RenderTarget2D colorMap, RenderTarget2D normalMap, RenderTarget2D shadowMap)
        {
            ColorMap = colorMap;
            NormalMap = normalMap;
            ShadowMap = shadowMap;
