    ...
    public class Pong
    {
        ...
        private void AddBalls(Vector2 Location, Vector2 Velocity, int Count)
        {
            ...
            for (int o = 0; o < Count; o++)
            {
                ...
                //else
                {
                    ...
                    float HighestChance = 0.025f;

                    #region Indecisive Ball
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 2"].Level, SkillTree.Skills["Special Ball 2"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                    ...
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 4"].Level, SkillTree.Skills["Special Ball 4"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                    ...
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 3"].Level, SkillTree.Skills["Special Ball 3"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                    ...
                    #region Worm Ball
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 5"].Level, SkillTree.Skills["Special Ball 5"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                    ...
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 6"].Level, SkillTree.Skills["Special Ball 6"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                    ...
                    #region Sine Ball
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 1"].Level, SkillTree.Skills["Special Ball 1"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
                        Balls[i].Value *= SkillTree.Skills["Special Ball 1"].Level * 2f;
                    ...
                    #region Gravity Ball
                    Chance = UsefulMethods.FindBetween(SkillTree.Skills["Special Ball 7"].Level, SkillTree.Skills["Special Ball 7"].Cost.Count, 0, HighestChance, 0f, false, 0.5f);
                    if (rand.NextDouble() < Chance)
                    {
        ...
        public List<Light> GetLights()
        {
            ...
            for (int i = 0; i < Paddles.Count; i++)
            {
                ...
                {
                    IsEnabled = true,
                    Color = Paddles[i].Tint.ToVector4() * 2f,
                    Power = 0.45f,
                    LightDecay = 100,
            ...
            for (int i = 0; i < Balls.Count; i++)
            {
                ...
                {
                    IsEnabled = true,
                    Color = Balls[i].P.Tint.ToVector4() * 2f,
                    Power = 0.3f,
                    LightDecay = 150,
        ...
        {           
            ...
            cam.SetRenderTarget(graphicsDevice, RenderMode.Regular);
            DrawBackground(spriteBatch, graphicsDevice, cam);
            DrawParticles(spriteBatch, graphicsDevice, cam);
            DrawPaddles(spriteBatch, graphicsDevice, cam);


            cam.SetRenderTarget(graphicsDevice, RenderMode.Bloom);
            DrawObjects(spriteBatch, graphicsDevice, cam);
            cam.SetRenderTarget(graphicsDevice, RenderMode.Regular);

            DrawBalls(spriteBatch, graphicsDevice, cam);


            cam.SetRenderTarget(graphicsDevice, RenderMode.UI);
            DrawUI(spriteBatch, graphicsDevice, cam);
        ...
        private void DrawBackground(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
            {
                ...
                Color Darkened =  ScoreColor * 0.333f;
                Darkened.A = 255;
                Darkened = new Color(45, 45, 45);

                Vector2 GameSize = GraphicsManager.GameResolution;
                new SkeletonTexture("Core", "Marker").Draw(spriteBatch, GameSize / 2f, Darkened, 0f, GameSize, SpriteEffects.None);
                ...
                if (TotalScore[ResourceName.Pixel].Amount > 1 || PixelsPerSecond > 0)
                    StaticInfoBox.Draw(spriteBatch, new Vector2((GraphicsManager.GameResolution.X / 2f), GraphicsManager.GameResolution.Y / 2f),
                        75f, 0.6f, 0f, new Color(25, 25, 25), new Vector2(16f), new BorderStyle("Default", ScoreColor, new Location(16f)));

            }
            spriteBatch.End();
        }

        private void DrawParticles(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
        ...
        private void DrawPaddles(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
            {
                SkeletonTexture Tex;
                ...
                for (int i = 0; i < Paddles.Count; i++)
                {
                    ...
                    if (!Paddles[i].Child)
                    {
                        ...
                        StaticInfoBox.Add(StringManager.ColorString("" + WriteNumber.Write(Paddles[i].Owner.Resource[ResourceName.Pixel].Amount, SeparatorType.Standard, true, ShortenType.Short_Scale), Color.White));
        ...
        private void DrawBalls(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
            {
        ...
        private void DrawObjects(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            if (Objects.Count > 0)
            {
                spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
        ...
        private void DrawUI(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);
            {
                for (int i = 0; i < ScoreCounters.Count; i++)
                {
                    ...
                    StaticInfoBox.Add(StringManager.ColorString(WriteNumber.Write(ScoreCounters[i].Amount, SeparatorType.Standard, true, ShortenType.Short_Scale), Color.White) + "");
                    ...
                    if (ScoreCounters[i].Owner != null)
                        ...
                        StaticInfoBox.Draw(spriteBatch, ScoreCounters[i].P.TruePosition,
                                ScoreCounters[i].P.Scale.Y, ScoreCounters[i].P.Alpha * 6f, 0f, "Tahoma");
                }
            }
            spriteBatch.End();

            DrawSkillTrees(spriteBatch, graphicsDevice, cam);
        }
        ...
        public void DrawSkillTrees(SpriteBatch spriteBatch, GraphicsDevice graphicsDevice, Camera cam)
        {
            for (int i = 0; i < Paddles.Count; i++)
            {
                if (Paddles[i].MainTree)
                {
                    ...
                    Paddles[i].MainSelector.cam.ClearRenderTargets(graphicsDevice);
                    ...
                    if (!DebugOptions.DrawNormals)
                    {
                        ...
                        {
                            if (l == 0)
                                SkillTree.Draw(spriteBatch, graphicsDevice, Paddles[i].MainSelector, rect);
                            else
                            {
                        ...
                        //float OriginalBrightness = LightManager.AmbientBrightness;
                        //LightManager.AmbientBrightness = 0.1f;


                        Paddles[i].MainSelector.cam.ApplyNormals(spriteBatch, graphicsDevice, SkillTree.GetLights(Paddles[i].MainSelector));
                        //Paddles[i].MainSelector.cam.ApplyNormalsUI(spriteBatch, graphicsDevice, SkillTree.GetLights(Paddles[i].MainSelector));

                        Paddles[i].MainSelector.cam.DrawFinalRender(spriteBatch, graphicsDevice);
                        Paddles[i].MainSelector.cam.BlurAmount = 12f;
                        Paddles[i].MainSelector.cam.BlurResolution = 30f;

                        //LightManager.AmbientBrightness = OriginalBrightness;
                    ...
                    cam.SetRenderTarget(graphicsDevice, RenderMode.Overlay);
                    spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, cam.Transform);

                    //DebugOptions.DrawNormals = false;
                    //new SkeletonTexture("Core", "Marker").Draw(spriteBatch, new Vector2(rect.X, rect.Y) + (new Vector2(rect.Width, rect.Height) / 2f)
                    //    , Color.Black, 0f, new Vector2(rect.Width, rect.Height), SpriteEffects.None);


                    spriteBatch.Draw(Paddles[i].MainSelector.cam.FinalRender, rect, Color.White);

                    BorderStyle border = new BorderStyle("Default", Paddles[i].Tint, new Location(8f));
