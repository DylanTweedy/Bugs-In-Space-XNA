...
namespace SkeletonEngine
{
    public class BloomComponent
    {
        ...
        public void LoadContent(GraphicsDevice graphics, ContentManager Content)
        {
            ...
            sceneRenderTarget = new RenderTarget2D(graphics, width, height, false,
            ...
            renderTarget1 = new RenderTarget2D(graphics, width, height, false, format, DepthFormat.None);
            renderTarget2 = new RenderTarget2D(graphics, width, height, false, format, DepthFormat.None);
        }
        ...
        /// </summary>
        public void BeginDraw(GraphicsDevice graphics)
        {
            //if (Visible)
            {
        ...
        /// </summary>
        public void Draw(GraphicsDevice graphics, RenderTarget2D renderTarget)
        {          
            ...
            DrawFullscreenQuad(graphics, sceneRenderTarget, renderTarget1,
                               bloomExtractEffect,
            ...
            DrawFullscreenQuad(graphics, renderTarget1, renderTarget2,
                               gaussianBlurEffect,
            ...
            DrawFullscreenQuad(graphics, renderTarget2, renderTarget1,
                               gaussianBlurEffect,
        ...
        /// </summary>
        void DrawFullscreenQuad(GraphicsDevice graphics, Texture2D texture, RenderTarget2D renderTarget,
