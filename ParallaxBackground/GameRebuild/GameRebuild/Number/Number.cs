...
namespace GameRebuild
{
    class Number
    {
        ...
        //NEEDS WORK (By turning the number into a list of "decimals"
        //            that grow and shrink based on the size of the
        //            number, you could in theory have numbers up to 
        //            300 figures. Two Lists, one for decimal numbers
        //            and one for whole numbers. Could also reduce
        //            memory cost.)
        public decimal Dec;
        public decimal Num;
        public decimal Sci;
