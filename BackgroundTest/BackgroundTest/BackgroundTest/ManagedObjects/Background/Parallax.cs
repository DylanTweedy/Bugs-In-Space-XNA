        ...
        public void Update(GameTime gameTime, int Camera)
        {
            ...
            else
            {
                for (int i = 0; i < starImages.Count; i++)
                {
                    ...
                    tint = (int)(255f * (CameraManager.CamerasRead[Camera].Zoom));
                ...
                {
                    int tint = (int)(255f * CameraManager.CamerasRead[Camera].Zoom);
                ...
                for (int i = 0; i < textures.Count; i++)
                {
                    for (int o = 0; o < sheets[i]; o++)
                    {
                        images[Counter].Position -= ((speed / 5) * ((i + 1f) / textures.Count)) * (CameraManager.CamerasRead[Camera].Zoom * 2);
