...
namespace BackgroundTest
{
    class World12
    {
        ...
        private struct Chunk
        {
            ...
            public void LoadCaves(ushort ChunkSize, ushort LandID, Random rand)
            {
                ...
                for (int x = 0; x < tiles.Length; x++)
                {
                    ...
                    for (int y = 0; y < tiles.Length; y++)
                    {
                        ...
                        tiles[x][y].variation = (byte)rand.Next(0, TileData.BlockTextureIDs[LandID].Count);
                        //tiles[x][y].slopeVariation = (byte)rand.Next(0, TileData.SlopeTextureIDs[LandID].Count);
                        tiles[x][y].rotation = (byte)rand.Next(0, 4);

                        tiles[x][y].BlockColor = TileData.BlockColor[LandID];
                    }
                }
            ...
            public void LoadCaves(ushort ChunkSize, ushort LandID, ushort LandID2, Random rand)
            {
                ...
                for (int x = 0; x < tiles.Length; x++)
                {
                    ...
                    for (int y = 0; y < tiles.Length; y++)
                    {
                        ...
                        tiles[x][y].variation = (byte)rand.Next(0, TileData.BlockTextureIDs[BlockID].Count);
                        //tiles[x][y].slopeVariation = (byte)rand.Next(0, TileData.SlopeTextureIDs[BlockID].Count);

                        tiles[x][y].BlockColor = TileData.BlockColor[BlockID];
                    }
                }
            ...
            public void LoadLand(ushort ChunkSize, ushort LandID, Random rand)
            {
                LandID = 4;
            ...
            public void LoadSky(ushort ChunkSize, Random rand)
            {
                tiles = new Tiles[ChunkSize][];
                ...
                for (int x = 0; x < tiles.Length; x++)
                {
                    ...
                    for (int y = 0; y < tiles.Length; y++)
                    {
                        tiles[x][y].BlockID = 0;
                        tiles[x][y].rotation = (byte)rand.Next(0, 4);
                        tiles[x][y].BlockColor = Color.White;
                    }
                }
        ...
        private void LoadChunk(int x, int y)
        {
            ...
            if (y * chunkTiles > SeaLevel + SeaLevelMax)
            {
                if (y * chunkTiles > SeaLevel + SeaLevelMax + chunkTiles)
                    chunks[x][y].LoadCaves(chunkTiles, LandID, random);
                else
            ...
            else
            {
                if (!chunks[x][y].ChunkActive)
                {
                    ...
                    if (y > CY)
                        if (!chunks[x][y].ChunkActive)
                        {
                            chunks[x][y].LoadLand(chunkTiles, 1, random);
            ...
            for (int x2 = 0; x2 < chunkTiles; x2++)
            {
                for (int y2 = HighPoint; y2 <= LowPoint; y2++)
                {
                    ...
                    if (!chunks[CX][CY].ChunkActive)
                        chunks[CX][CY].LoadLand(chunkTiles, 1, random);
                                ...
                                switch (speed)
                                {
                                    case 1:
                                        if (random.Next(0, 25) == 0)
                                        {
                                            ...
                                            //chunks[ACX][ACY].tiles[ATX][ATY].slopeVariation = (byte)random.Next(0, TileData.SlopeTextureIDs[activeBlocks[i].BlockID].Count);
                            ...
                            {    
                                    ...
                                    (y * chunkTiles) + y2 > RenderTileY && (y * chunkTiles) + y2 < RenderTileY2)
                                {
                                    ...
                                    if (ID != 0)
                                    {
                                        ...
                                        //if (ActiveChunk)
                                        //    if (chunks[CX][CY].tiles[TX][TY].BlockID < blockID)
                                        //        Left = true;
                                        ...
                                        //spriteBatch.Draw(TileData.TexturesTestSheet[0], position, rect, TileData.BlockColor[ID], 0f, origin, 1f, SpriteEffects.None, 0f);
                                    ...
                                    else
                                    {
                                        ...
                                        if (Up && Left && blockIDU == blockIDL)
                                        {
                                            ...
                                            //spriteBatch.Draw(TileData.MaskSheets[0], pos, rect, uColor, rotation, origin, 1f, SpriteEffects.None, 0f);
                                        }
                                        ...
                                        if (Down && Left && blockIDD == blockIDL)
                                        {
                                            ...
                                            //spriteBatch.Draw(TileData.MaskSheets[0], pos, rect, lColor, rotation, origin, 1f, SpriteEffects.None, 0f);
                                        }
                                        ...
                                        if (Up && Right && blockIDU == blockIDR)
                                        {
                                            ...
                                            //spriteBatch.Draw(TileData.MaskSheets[0], pos, rect, rColor, rotation, origin, 1f, SpriteEffects.None, 0f);
                                        }
                                        ...
                                        if (Down && Right && blockIDD == blockIDR)
                                        {
                                            ...
                                            //        break;
                                            //}
                                            //spriteBatch.Draw(TileData.MaskSheets[0], pos, rect, dColor, rotation, origin, 1f, SpriteEffects.None, 0f);
                                        }
                                    }
                                }
                            }
