...
namespace SkeletonEngine
{
    static class CameraManager
    {
        ...
        static public List<Camera> GetCameraList()
        {
            List<Camera> cameraList = new List<Camera>();
            cameraList.AddRange(MainCameras);
        ...
        static public void Update()
        {
            ...
            if (InputManager.KBPressed(true, Microsoft.Xna.Framework.Input.Keys.Add))
                AddMainCamera(Vector2.Zero, 0f, 1f);
            if (InputManager.KBPressed(true, Microsoft.Xna.Framework.Input.Keys.Subtract))
        ...
        static public void DrawMainCameras()
        {
            ...
            for (int i = 0; i < MainCameras.Count; i++)
                MainCameras[i].Bounds = new Rectangle((int)Positions[i].X, (int)Positions[i].Y, MainCameras[i].FinalRender.Width, MainCameras[i].FinalRender.Height);
