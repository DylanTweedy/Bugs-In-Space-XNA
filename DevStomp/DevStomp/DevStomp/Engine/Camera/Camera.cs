...
namespace SkeletonEngine
{
    ...
    public class Camera
    {
        ...
        public SubCameras subCameras = new SubCameras();
        ...
        public Camera(Vector2 position, float rotation, float zoom, InputType input)
        {
            ...
            Para.Add(new ParallaxParticles());
            Para[Para.Count - 1].SetState(0.25f, 1.5f, 0.5f, "Stars", ColorManager.Spectrum(Color.Red), 1f, 1f, true, false, move);
            Para.Add(new ParallaxParticles());
            Para[Para.Count - 1].SetState(0.1f, 1f, 0.1f, "GasCloud", ColorManager.Compliment(Color.Red), 5f, 0.5f, false, false, move);
            Para.Add(new ParallaxParticles());
            Para[Para.Count - 1].SetState(1f, 1.5f, 0.5f, "Dust", new List<Color>() { Color.White }, 1f, 1f, true, false, move);
            Para.Add(new ParallaxParticles());
            Para[Para.Count - 1].SetState(0.25f, 1.5f, 0.5f, "Stars", ColorManager.Spectrum(Color.Red), 1f, 1f, true, false, move);
            Para.Add(new ParallaxParticles());
            Para[Para.Count - 1].SetState(0.1f, 1f, 0.1f, "GasCloud", ColorManager.Compliment(Color.Red), 5f, 0.5f, false, false, move);
