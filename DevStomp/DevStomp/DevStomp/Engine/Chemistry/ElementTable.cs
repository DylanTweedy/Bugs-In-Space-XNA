...
namespace SkeletonEngine
{
    ...
    static class ElementTable
    {
        ...
        static public void Initialize(ContentManager Content, SpriteBatch spritebatch, GraphicsDevice graphicsDevice)
        {
            ...
            random = new Random(GlobalVariables.ElementSeed);
            graphicsRandom = new Random(GlobalVariables.ElementSeed);
            colorRandom = new Random(GlobalVariables.ElementSeed);
            propertyRandom = new Random(GlobalVariables.ElementSeed);
        ...
        static private void AddElements()
        {
            ...
            AddElement("Element 203", "Tmp19", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 204", "Tmp20", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 205", "Tmp21", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 206", "Tmp22", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 207", "Tmp23", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 208", "Tmp24", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 209", "Tmp25", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 210", "Tmp26", 0f, 0f, 0f, 0f, 16, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 211", "Tmp27", 0f, 0f, 0f, 0f, 17, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 212", "Tmp28", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 213", "Tmp29", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 214", "Tmp30", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 215", "Tmp31", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 216", "Tmp32", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 217", "Tmp33", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 218", "Tmp34", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 219", "Tmp35", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 220", "Tmp36", 0f, 0f, 0f, 0f, 16, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 221", "Tmp37", 0f, 0f, 0f, 0f, 17, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 222", "Tmp38", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 223", "Tmp39", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 224", "Tmp30", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 225", "Tmp41", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 226", "Tmp42", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 227", "Tmp43", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 228", "Tmp44", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 229", "Tmp45", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 230", "Tmp46", 0f, 0f, 0f, 0f, 16, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 231", "Tmp47", 0f, 0f, 0f, 0f, 17, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 232", "Tmp48", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 233", "Tmp49", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 234", "Tmp50", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 235", "Tmp51", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 236", "Tmp52", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 237", "Tmp53", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 238", "Tmp54", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 239", "Tmp55", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 240", "Tmp56", 0f, 0f, 0f, 0f, 16, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 241", "Tmp57", 0f, 0f, 0f, 0f, 17, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 242", "Tmp58", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 243", "Tmp59", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 244", "Tmp60", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 245", "Tmp61", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 246", "Tmp62", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 247", "Tmp63", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 248", "Tmp64", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 249", "Tmp65", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 250", "Tmp66", 0f, 0f, 0f, 0f, 16, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 251", "Tmp67", 0f, 0f, 0f, 0f, 17, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 252", "Tmp68", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 253", "Tmp69", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
            AddElement("Element 254", "Tmp70", 0f, 0f, 0f, 0f, 18, 11, 13, new Color(0, 0, 0, 0), 0f, 0f, 0f, 0f, "");
        ...
        static private void DrawTexture()
        {
            ...
            for (int n = 0; n < 4; n++)
            {
                renderTargets.Add(new RenderTarget2D(gDevice, GlobalVariables.TileSize * 2, GlobalVariables.TileSize * 2));
                ...
                for (int i = 0; i < Compounds[Compounds.Count - 1].ElementCounts.Count; i++)
                    for (int o = 0; o < Compounds[Compounds.Count - 1].ElementCounts[i]; o++)
                    {
                        ...
                        pos = new Vector2(GlobalVariables.TileSize, GlobalVariables.TileSize);
                        size = 1f;
                        ...
                        spriteBatch.Draw(
                            ...
                            color,
                            rotation,
                            new Vector2(GlobalVariables.TileSize, GlobalVariables.TileSize),
                            size,
                            SpriteEffects.None,
                            1f);
                    }
        ...
        static public List<long> BuildTable(long Total)
        {
            List<long> ProbabilityList = new List<long>();
            ...
            {
                chance = random.NextDouble() / (i * i);
                ProbabilityList[i] += (long)(dest * chance);
                dest -= (long)(dest * chance) * i;
            }

            chance = random.NextDouble() / (256 * 256);
            ProbabilityList[0] += (long)(dest * chance);
            dest -= (long)(dest * chance) * 256;

            ProbabilityList[1] += dest;
        ...
        //            if (total < dest)
        //            {
        //                long prob2 = ((dest - total) / (i + 1)) + 1;

        //                if (prob2 > int.MaxValue)
        //                {
        //                    double n = (double)prob2 / int.MaxValue;
        //                    int count = (int)Math.Floor(n);
        //                    n -= count;

        //                    for (int o = 0; o < count; o++)
        //                        final += random.Next(0, int.MaxValue);

        //                    final += random.Next(0, (int)((prob2 - (int.MaxValue * (long)count)) * n));
        //                }
        //                else
        //                    final = random.Next(0, (int)prob2);
        //            }
