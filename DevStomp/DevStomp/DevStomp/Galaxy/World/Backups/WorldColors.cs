                ...
                public void Initialize(Vector2 Position, int QuadSize, byte Shape, GraphicsDevice graphics, float[] Interp, byte ID)
                {
                    ...
                    switch (Shape)
                    {
                        case 0:
                            ...
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                        ...
                        case 1:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * Interp[0]), 0), color, new Vector2(0, Interp[0]));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[2])), Position.Y + QuadSize, 0), color, new Vector2((1 - Interp[2]), 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                        ...
                        case 2:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[3]), Position.Y + QuadSize, 0), color, new Vector2(Interp[3], 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * Interp[1]), 0), color, new Vector2(1, Interp[1]));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                        ...
                        case 3:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * Interp[0]), 0), color, new Vector2(0, Interp[0]));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * Interp[1]), 0), color, new Vector2(1, Interp[1]));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                        ...
                        case 4:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * (1 - Interp[2])), 0), color, new Vector2(1, (1 - Interp[2])));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[0]), Position.Y, 0), color, new Vector2(Interp[0], 0));
                        ...
                        case 5:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * Interp[0]), 0), color, new Vector2(0, Interp[0]));
                            vertices[5] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[0]), Position.Y, 0), color, new Vector2(Interp[0], 0));

                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[2])), Position.Y + QuadSize, 0), color, new Vector2((1 - Interp[2]), 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * (1 - Interp[2])), 0), color, new Vector2(1, (1 - Interp[2])));
                        ...
                        case 6:
                            ...
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[3]), Position.Y + QuadSize, 0), color, new Vector2(Interp[3], 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[0]), Position.Y, 0), color, new Vector2(Interp[0], 0));
                        ...
                        case 7:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y, 0), color, new Vector2(0, 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * Interp[0]), 0), color, new Vector2(0, Interp[0]));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * Interp[0]), Position.Y, 0), color, new Vector2(Interp[0], 0));
                        ...
                        case 8:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * (1 - Interp[3])), 0), color, new Vector2(0, (1 - Interp[3])));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[1])), Position.Y, 0), color, new Vector2((1 - Interp[1]), 0));
                        ...
                        case 9:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[1])), Position.Y, 0), color, new Vector2((1 - Interp[1]), 0));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[2])), Position.Y + QuadSize, 0), color, new Vector2((1 - Interp[2]), 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                        ...
                        case 10:
                            ...
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * Interp[1]), 0), color, new Vector2(1, Interp[1]));
                            vertices[4] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                            vertices[5] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[1])), Position.Y, 0), color, new Vector2((1 - Interp[1]), 0));
                        ...
                        case 11:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * Interp[1]), 0), color, new Vector2(1, Interp[1]));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y, 0), color, new Vector2(1, 0));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[1])), Position.Y, 0), color, new Vector2((1 - Interp[1]), 0));
                        ...
                        case 12:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + (QuadSize * (1 - Interp[3])), 0), color, new Vector2(0, (1 - Interp[3])));
                            vertices[3] = new VertexPositionColorTexture(new Vector3(Position.X, Position.Y + QuadSize, 0), color, new Vector2(0, 1));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * (1 - Interp[2])), 0), color, new Vector2(1, (1 - Interp[2])));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                        ...
                        case 13:
                            ...
                            vertices[0] = new VertexPositionColorTexture(new Vector3(Position.X + (QuadSize * (1 - Interp[2])), Position.Y + QuadSize, 0), color, new Vector2((1 - Interp[2]), 1));
                            vertices[1] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + QuadSize, 0), color, new Vector2(1, 1));
                            vertices[2] = new VertexPositionColorTexture(new Vector3(Position.X + QuadSize, Position.Y + (QuadSize * (1 - Interp[2])), 0), color, new Vector2(1, (1 - Interp[2])));
            ...
            public void CalculateChunk(GraphicsDevice graphics, Vector2 Position, int QuadSize, int ChunkSize)
            {
                ...
                for (int x = 0; x < ChunkSize; x++)
                {
                    ...
                    for (int y = 0; y < ChunkSize; y++)
                    {
                        ...
                        ChunkQuads[x][y] = new Quad[ids.Count];

                        for (int i = 0; i < ids.Count; i++)
                        {
                            N = 0;

                            if (Interpolation[x][y] == 0 || ids[i] != ID[x][y])
                                N += 8;
                            if (Interpolation[x + 1][y] == 0 || ids[i] != ID[x + 1][y])
                                N += 4;
                            if (Interpolation[x + 1][y + 1] == 0 || ids[i] != ID[x + 1][y + 1])
                                N += 2;
                            if (Interpolation[x][y + 1] == 0 || ids[i] != ID[x][y + 1])
                                N += 1;
                            ...
                            if (N != 15)
                            {
                                ChunkQuads[x][y][i] = new Quad();
                                ChunkQuads[x][y][i].Initialize(Position + new Vector2(QuadSize * x, QuadSize * y), QuadSize, N, graphics, IntX, ids[i]);
                                VerticiesLength += ChunkQuads[x][y][i].vertices.Length;
                                IndicesLength += ChunkQuads[x][y][i].indices.Length;
                            }
                        }
                    }
                }
                ...
                for (int x = 0; x < ChunkQuads.Length; x++)
                    for (int y = 0; y < ChunkQuads[x].Length; y++)
                        for (int o = 0; o < ChunkQuads[x][y].Length; o++)
                        {
                            if (ChunkQuads[x][y][o] != null)
                            {
                                for (int i = 0; i < ChunkQuads[x][y][o].indices.Length; i++)
                                {
                                    indices[I] = (short)(ChunkQuads[x][y][o].indices[i] + V);
                                    I++;
                                }

                                for (int i = 0; i < ChunkQuads[x][y][o].vertices.Length; i++)
                                {
                                    vertices[V] = ChunkQuads[x][y][o].vertices[i];
                                    V++;
                                }
                            }
                        }
        ...
        public Vector2 CheckTile(Vector2 Pos, Vector2 PreviousPos)
        {
            ...
            if (SelectedChunk.X >= 0 && SelectedChunk.X < WorldX && SelectedChunk.Y >= 0 && SelectedChunk.Y < WorldY)
            {
                if (TestChunk[(int)SelectedChunk.X][(int)SelectedChunk.Y].ChunkQuads[(int)ChunkPosition.X][(int)ChunkPosition.Y] != null)
                {
                    ...
                    short[] Indices = TestChunk[(int)SelectedChunk.X][(int)SelectedChunk.Y].ChunkQuads[(int)ChunkPosition.X][(int)ChunkPosition.Y][0].indices;
                    VertexPositionColorTexture[] Vertices = TestChunk[(int)SelectedChunk.X][(int)SelectedChunk.Y].ChunkQuads[(int)ChunkPosition.X][(int)ChunkPosition.Y][0].vertices;
