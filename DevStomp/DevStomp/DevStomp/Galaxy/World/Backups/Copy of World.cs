...
namespace DevStomp
{
    class World2
    {
        ...
        {
            public Vector2 dx; // dx/dt = velocity
            public Vector2 dv; // dv/dt = acceleration
        }
        ...
        Vector2 acceleration(State state, float t)
        {
            float k = 10;
            float b = 1;
        ...
        private State integrate(State state, float t, float dt)
        {
            Derivative a = Evaluate(state, t, 0f, new Derivative());
            Derivative b = Evaluate(state, t, dt * 0.5f, a);
            Derivative c = Evaluate(state, t, dt * 0.5f, b);
            Derivative d = Evaluate(state, t, dt, c);

            Vector2 dxdt = 1f / 6f * (a.dx + 2f * (b.dx + c.dx) + d.dx);
            Vector2 dvdt = 1f / 6f * (a.dv + 2f * (b.dv + c.dv) + d.dv);
        ...
        public void Initialize(Vector2 position, GraphicsDevice graphics, int id, float centerMass, byte Type)
        {
            ...
            UpperLimit = (short)GlobalVariables.RandomNumber.Next(1250, 2000);

            switch (ObjectType)
            {
                case 0:
                    size = GlobalVariables.RandomNumber.Next(1250, 2000);
                    break;

                case 1:
                    size = GlobalVariables.RandomNumber.Next(800, 2000);
                    break;

                case 2:
                    size = GlobalVariables.RandomNumber.Next(300, 800);
                    break;
                    
                case 3:
                    size = GlobalVariables.RandomNumber.Next(20, 300);
                    break;

                case 4:
                    size = GlobalVariables.RandomNumber.Next(1, 20);
                    break;
            ...
            RotationalVelocity = GlobalVariables.RandomNumber.Next(0, 10000) / 10000f;
            RotationalVelocityClouds = GlobalVariables.RandomNumber.Next(0, 10000) / 10000f;
            
            SetupTextures();
        }

        List<Color> Pallet = ColorManager.Triad(ColorManager.RandomFullColor(), false, GlobalVariables.RandomNumber.Next(30, 151));
        ...
        private void SetupChemistry()
        {
            ...
            Chemistry = ElementTable.BuildTable((long)262144 * (long)area);
        ...
        public void Draw(SpriteBatch spriteBatch, GraphicsDevice graphics)
        {
            ...
            if (InputManager.KB.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.L))
                switch (ObjectType)
                {
                    ...
                    default:
                        ...
                        {
                            multiplier = (0.01f / (Scale * CameraManager.Cams[camera].Z));
                            Scale *= multiplier;
                            objectScale *= multiplier;
                        }
                        break;
            ...
            else
            {
                ...
                if (objectScale > scaleLow)
                {
                    ...
                    spriteBatch.Draw(TexBody, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDBody], ColorBody * Alpha, Rotation, halfsize, Scale, SpriteEffects.None, 0f);
                            
                    switch (ObjectType)
                    {
                        case 3:
                        case 4:
                            spriteBatch.Draw(TexOverlay, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDOverlay], ColorOverlay * 0.7f * Alpha, Rotation + OverlayRotation, halfsize, Scale, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexGlow, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDGlow], ColorOverlay * 0.7f * Alpha, Rotation, halfsize, Scale, SpriteEffects.None, 0f);
                            break;

                        case 5:
                            spriteBatch.Draw(TexClouds, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDClouds], ColorBody * 0.2f * Alpha, -CloudRotation, halfsize, Scale * 2f, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexClouds, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDClouds], ColorBody * 0.2f * Alpha, CloudRotation, halfsize, Scale * 2f, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexBody, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDBody], Color.White * 0.5f * Alpha, Rotation + OverlayRotation, halfsize, Scale, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexGlow, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDGlow], ColorBody * 1f * Alpha, CloudRotation + OverlayRotation, halfsize, Scale, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexGlow, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDGlow], Color.White * 0.7f * Alpha, CloudRotation, halfsize, Scale, SpriteEffects.None, 0f);
                            break;

                        default:
                            spriteBatch.Draw(TexOverlay, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDOverlay], ColorOverlay * 0.7f * Alpha, Rotation + OverlayRotation, halfsize, Scale, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexClouds, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDClouds], ColorClouds * 0.85f * Alpha, CloudRotation, halfsize, Scale * 1.01f, SpriteEffects.None, 0f);
                            spriteBatch.Draw(TexGlow, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDGlow], ColorOverlay * 0.8f * Alpha, Rotation, halfsize, Scale, SpriteEffects.None, 0f);
                            float angle = UsefulMethods.VectorToAngle(-P.RoughPosition);
                            spriteBatch.Draw(TexShadows, P.Position + DrawOffset, SM.PlanetBody.Rectangles[IDShadows], Color.White * Alpha, angle, halfsize, Scale, SpriteEffects.None, 0f);
                            break;
                    }
                    ...
                    if (CameraManager.Cams[camera].settings.SpaceView.ShowInfo)
                    {
                        ...
                        if (alpha > 0f)
                        {
                            ...
                            StaticInfoBox.AddItem("Mass: " + (float)Mass);
